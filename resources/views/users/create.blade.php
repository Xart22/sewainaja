...
@section('content')
<div class="mt-14">
    <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Create User</h1>
        ...
        <div class="bg-white rounded-lg shadow-lg dark:bg-gray-800 p-5 mt-5 ">
            <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                <div>
                    ...
                    <input name="nip" id="nip" type="text" value="{{ old('nip') }}" required
                ...
                <div>
                    ...
                    <input name="phone_number" id="phone_number" type="text" required value="{{ old('phone_number') }}"
