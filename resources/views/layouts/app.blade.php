...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 bg-[#f9fafb]">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="flex ms-2 md:me-24">
                        <img src="{{ asset('assets/logo/sewainaja-blue.png') }}" class="h-8 me-3" alt="Sewainaja">
                    </div>
                </div>
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('data-permohonan.index',[ date('Y-m-d', strtotime('-1 month')),date('Y-m-d')]) }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('master-data.hardware.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Hardware</a>
                        </li>
                        <li>
