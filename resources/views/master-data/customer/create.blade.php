            ...
            <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="customer_notes" id="customer_notes" rows="3"
                        class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">{{ old('customer_notes') }}</textarea>
                </div>
