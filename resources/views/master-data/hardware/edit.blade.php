...
<div class="mt-14">
    ...
    <div class="bg-white rounded-lg shadow-lg dark:bg-gray-800 p-5 mt-5 ">
        ...
        <form action="{{ route('master-data.hardware.update', $hardware->id) }}" method="POST"
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                <div>
                    ...
                    <input name="hardware_name" id="hardware_name" type="text" required
                        value="{{ old('hardware_name', $hardware->hw_name) }}"
                ...
                <div>
                    ...
                    <input name="hardware_type" id="hardware_type" type="text" required
                        value="{{ old('hardware_type', $hardware->hw_type) }}"
                        class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                <div>
                    ...
                    <input name="hardware_brand" id="hardware_brand" type="text" required
                        value="{{ old('hardware_brand', $hardware->hw_brand) }}"
                        class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                <div>
                    <label class="text-gray-700 dark:text-gray-200" for="hardware_model">Hardware Model</label>
                    <input name="hardware_model" id="hardware_model" type="text"
                        value="{{ old('hardware_model', $hardware->hw_model) }}"
                        class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                ...
                <div>
                    ...
                    <input name="hardware_technology" id="hardware_technology" type="text"
                        value="{{ old('hardware_technology', $hardware->hw_technology) }}"
                        class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                <div>
                    ...
                    <input name="hardware_bw_color" id="hardware_bw_color" type="text"
                        value="{{ old('hardware_bw_color', $hardware->hw_bw_color) }}"
                        class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                <div>
                    ...
                    <input name="hw_serial_number" id="hw_serial_number" type="text" required
                        value="{{ old('hw_serial_number',$hardware->hw_serial_number) }}" class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring
            ...
            <div class="mt-5">
                ...
                <textarea name="hardware_description" id="hardware_description" type="text" rows="4"
                    class="block w-full mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:outline-none focus:ring">{{ old('hardware_description', $hardware->hw_description) }}</textarea>
            </div>
